...
- serious literary graphic novel;
- ancient Tamil maritime Puhar, South India;
...
### Madhavi — first reveal only

- mature Tamil woman, accomplished former court/performance artist;
- disciplined posture remains visible beneath plain clothing;
- grief expressed through stillness, not collapse;
- hair simply arranged;
- no glamour-lighting shorthand;
- no Buddhist iconographic markers that the current evidence package has not cleared.

### Manimekalai — partial reveal only

- young adult Tamil woman;
- only silhouette/profile/partial face on Page 8;
- poised, observant, not passive;
- fuller character turnaround must be approved before Chapter 2 rendering.

## GN-CH01-P001 — opening splash
...
Reject or revise any frame that contains:

- implausible fantasy skyline;
- recognisable modern South Indian temple towers inserted without evidence;
