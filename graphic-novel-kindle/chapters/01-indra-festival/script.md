...
`Primary: canto 1 premise | repo staging reference: FU-001 | VENPA-BHARATHIDASAN: THEMATIC | [INTERPRETATION]`

---

## PAGE 2 — GN-CH01-P002

### Panel A — wide horizontal

Harbour workers shoulder a wet timber beam beneath a vessel under repair. A rope maker twists fibre beside them.
...
Flower workers sort unopened jasmine by touch in dim light.
...
The drummer and civic messengers prepare to move through the streets.
...
`[INTERPRETATION] — civic-water staging adapted from existing screenplay logic; not claimed as canto-1 textual detail.`
...
Wrapped instruments. An unlit lamp. A performance anklet resting unused.
...
`Transition into canto 2 | repo staging reference: FU-003 | [INTERPRETATION]`

---

# Pilot editorial notes
...
- exact festival terminology and duration if stated in captions later;
- civic proclamation details against the selected primary Tamil edition;
- historical plausibility of water-storage design;
- harbour craft and repair methods;
- flower/garland labour details;
- costume and instrument design;
- whether any newly written line accidentally resembles a modern copyrighted retelling.
