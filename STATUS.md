...
| 09 | Production design | Bible 0.1 active | Puhar map, water calendar, Amudhasurabhi, food-service and animal-welfare plates complete; remaining plates, tests and specialist approval remain |
...
|---|---:|
| Current tracked paths audited | 275 |
...
- Per-file audit ledger: **275 current paths recorded**.
...
6. Continue storyboard and department plates; run prop/service tests and obtain joint animal-welfare/ritual-history review before animal shot lock.
